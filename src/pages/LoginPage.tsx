...
const LoginPage = () => {
  ...
  const widthClass = "w-[calc(50%-16px)] xsm:w-[calc(33%-22px)] max-w-[150px]";
  ...
  return (
    <PageWrapper disablePaddingTop>
      <div className="flex flex-col justify-center h-[100dvh]">
        ...
        <ul className="flex flex-wrap xsm:justify-center mt-[80px] md:w-[80%] md:mx-auto md:mt-[120px] gap-x-8 gap-y-4">
          {/* Users */}
